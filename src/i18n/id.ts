...
export const id: Dict = {
  ...
  orgTree: {
    ...
    labels: {
      ...
      'Follow-up, MC & Media Sosial': 'Follow-up, MC & Media Sosial',
      'PIC Ibadah — Worship & Personel Liturgi': 'PIC Ibadah — Worship & Personel Liturgi',
      'Koordinator Doa': 'Koordinator Doa',
      'Intercessor Pra-During-Pasca': 'Intercessor Pra-During-Pasca',
      'Penyusun Modul & Kurikulum': 'Penyusun Modul & Kurikulum',
      'Main Speaker — Pembekal Mentor & Comentor': 'Main Speaker — Pembekal Mentor & Comentor',
      'PIC Logistik — Akomodasi & Peralatan': 'PIC Logistik — Akomodasi & Peralatan',
      'PIC Konsumsi — Vendor & Self-Made': 'PIC Konsumsi — Vendor & Self-Made',
      'First Aid & Kesehatan': 'First Aid & Kesehatan',
      'Foto & Video': 'Foto & Video',
      'PIC MTDD — Multimedia, Dokumentasi & Publikasi': 'PIC MTDD — Multimedia, Dokumentasi & Publikasi',
      'Perlengkapan & Pelatihan Injili': 'Perlengkapan & Pelatihan Injili',
      'Kepala Benzarpreneurship (BZP)': 'Kepala Benzarpreneurship (BZP)',
      'Produksi & Penjualan Merchandise': 'Produksi & Penjualan Merchandise',
      'Usaha Dana & Penggalangan Dana': 'Usaha Dana & Penggalangan Dana',
      'Pengelolaan Persembahan & Donasi': 'Pengelolaan Persembahan & Donasi',
      'Liturgi & Musik': 'Liturgi & Musik',
      Pendoa: 'Pendoa',
      Intercessor: 'Intercessor',
      'Kurikulum & Pembekalan': 'Kurikulum & Pembekalan',
      'Program Persekutuan': 'Program Persekutuan',
      'Public Relations (PR)': 'Public Relations (PR)',
      'Logistik & Akomodasi': 'Logistik & Akomodasi',
      Konsumsi: 'Konsumsi',
      'Medis & First Aid': 'Medis & First Aid',
      Dokumentasi: 'Dokumentasi',
      'Desain & Publikasi': 'Desain & Publikasi',
      'Penginjilan Praktis': 'Penginjilan Praktis',
      Merchandise: 'Merchandise',
      Fundraising: 'Fundraising',
      Donation: 'Donation',
      Anggota: 'Anggota',
      'Tim Penyusun Modul': 'Tim Penyusun Modul',
