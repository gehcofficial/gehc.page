...
export const id: Dict = {
  ...
  about: {
    ...
    leadSoon:
      'Susunan pengurus baru periode 2026–2031 akan segera diumumkan setelah ditetapkan oleh BPMJ. Struktur di bawah memperlihatkan cara lima fungsi pelayanan kami bekerja bersama.',
    verse:
  ...
  leadersPage: {
    ...
    announceBody:
      'Nama-nama tim pengurus periode 2026–2031 akan dipublikasikan di sini setelah ditetapkan oleh majelis gereja.',
    bpmjLabel: 'BPMJ',
  ...
  orgTree: {
    ...
    komisiTitle: 'Komisi Pemuda — dipimpin Penatua Pemuda · periode 2026–2031',
  ...
  pwa: {
    ...
    installDesc: 'Pasang GEHC Youth di layar utama — akses lebih cepat, bisa offline.',
    installHint: 'Membuka dialog install dari browser.',
    installed: 'Aplikasi sudah terpasang',
    installedHint: 'Anda memakai versi terpasang.',
    iosTitle: 'Install di iPhone/iPad',
    iosSteps: 'Buka menu Bagikan, lalu pilih "Tambah ke Layar Utama".',
    updateAvailable: 'Versi baru tersedia',
    updateDesc: 'Muat ulang untuk memakai versi terbaru.',
    ...
    refreshing: 'Menyegarkan aplikasi…',
    refreshApp: 'Muat ulang paksa',
  },
  portal: portalId,
};
