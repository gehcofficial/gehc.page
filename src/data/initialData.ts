...
export const INITIAL_TENANTS: Tenant[] = [
  ...
  {
    id: 'tenant-teen',
    name: 'Pra Remaja (Teen)',
    slug: 'teen',
    domain: 'teen.gehc.page',
    badge: 'Next Ecosystem',
    description: 'Komisi Pelayanan Pra Remaja GMIM Eben Haezer Cikarang',
    is_active: false,
    defaultBipra: 'REMAJA',
  ...
  },
  {
    ...
    name: 'Anak (Kids)',
    slug: 'kids',
    domain: 'kids.gehc.page',
    badge: 'Next Ecosystem',
    description: 'Pelayanan Anak & Sekolah Minggu GMIM Eben Haezer Cikarang',
    is_active: false,
    defaultBipra: 'ANAK',
    registrationOpen: false,
  },
