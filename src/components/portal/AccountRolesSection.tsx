    ...
    <div className="space-y-4 max-w-xl">
      <div className="rounded-2xl border border-[#D9D7D0] bg-white p-5">
        ...
        <p className="text-[11px] text-[#8C8880] mb-4">
          Satu akun bisa memegang beberapa peran. Pilih peran untuk membuka panel namespace yang sesuai.
        </p>
        <div className="space-y-2">
          {myRoleOptions.map((role) => (
            ...
            >
              ...
              {role === currentRole && (
                <span className="text-[9px] font-bold uppercase text-[#FF416C] shrink-0">Aktif</span>
              )}
