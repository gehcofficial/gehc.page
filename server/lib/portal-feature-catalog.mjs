...
export const PORTAL_FEATURE_CATALOG = [
  ...
  { id: 'wa-channels', page: 'wa-channels', roles: ['SUPERADMIN', 'KOMISI', 'COMMITTEE', 'BPMJ'], title: 'Kanal WhatsApp', purpose: 'Link grup permanen & per event.', steps: ['Buka Kanal WhatsApp.', 'Pilih layer permanen (Beyonders, divisi, kepemimpinan, BIPRA, wilayah & kolom, rekreasi) atau event.', 'Rekreasi memakai dropdown — pilih minat dulu.', 'Tempel & simpan link.'] },
  ...
  { id: 'announcements', page: 'announcements', roles: [], title: 'Pengumuman (notifikasi)', purpose: 'Kirim notifikasi aplikasi (lonceng + push) ke publik/peran/divisi/kelompok/orang.', steps: ['Buka Pengumuman.', 'Tulis pesan & pilih audiens.', 'Kirim atau jadwalkan.'] },
  { id: 'broadcast-wa', page: 'groups-monitoring', roles: ['SUPERADMIN', 'KOMISI', 'MENTOR', 'CO_MENTOR'], title: 'Broadcast WhatsApp mentee', purpose: 'Nomor WhatsApp mentee kelompok (bukan notifikasi aplikasi).', steps: ['Buka Monitoring Kelompok.', 'Tab Roster.', 'Broadcast WA (nomor).'] },
